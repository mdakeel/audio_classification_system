...
list_of_files = [
    ...
    f"{package_name}/components/model_training.py",
    f"{package_name}/components/model_evaluation.py",
    f"{package_name}/components/mode_pusher.py",
    f"{package_name}/constants/__init__.py",
    f"{package_name}/configuration/__init__.py",
    f"{package_name}/configuration/aws_connection.py",
    f"{package_name}/configuration/s3_opearations.py",
